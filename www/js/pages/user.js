            ...
            loginRequest.then(function (res) {
                switch (res.code) {
                    case 0 :
                        ...
                        var new_userinfo = res.data.user;
                        app.genQrCode(new_userinfo.id, function (base64File) {
                            new_userinfo.qrcode = base64File;
                            //alert(base64File);

                            alert(new_userinfo.qrcode);
                            new_userinfo = JSON.stringify(res.data.user);

                            if (old_userinfo !== new_userinfo) {
